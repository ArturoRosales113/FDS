...
@section('content')
 ...
 <!-- End Navbar -->
  <div class="wrapper">
   @include('Frontend.Index.Sections.header')
 ...
 <div class="section section-contact-us text-center">
     ...
     <div class="container">
         ...
         <div class="copyright">
             © <script type="text/javascript" async="" src="https://ssl.google-analytics.com/ga.js"></script><script>document.write(new Date().getFullYear())</script>2018, Designed by <a href="http://www.invisionapp.com" target="_blank">Invision</a>. Coded by <a href="https://www.creative-tim.com" target="_blank">Creative Tim</a>.
         </div>
     </div>
